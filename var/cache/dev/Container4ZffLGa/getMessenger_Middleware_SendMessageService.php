...
class getMessenger_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Message\\SmsNotification' => [0 => 'async_priority_high']], ($container->privates['.service_locator.rCNnWz1'] ?? $container->load('get_ServiceLocator_RCNnWz1Service'))), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
