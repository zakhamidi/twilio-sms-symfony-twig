 ...
 */
class getSmsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SmsRepository' shared autowired service.
     *
     * @return \App\Repository\SmsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SmsRepository.php';

        return $container->privates['App\\Repository\\SmsRepository'] = new \App\Repository\SmsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
